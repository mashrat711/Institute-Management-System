                                            ...
                                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                ...
                                                @foreach($uni_courses as $uni_course)
                                                    <tr>
                                                        <td>{{$uni_course->id}}</td>
                                                        <td>{{$uni_course->name}}
                                                        <td>{{$uni_course->course_id}}</td>
                                                        <td>{{$uni_course->shift}}</td>
                                                        <td>{{$uni_course->section}}</td>
                                                        <td>{{$uni_course->group}}</td>
                                                        <td>{{$uni_course->level}}</td>
                                                        <td>{{$uni_course->remark}}</td>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{--</div>--}}
                                                            <div class="btn-group">
                                                                <a title="Edit" href="{{route('TrainingInstitute.edit', $uni_course->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                                                </a>
                                                            </div>
                                                        {{--<div class="btn-group">--}}
                                                        ...
                                                        <!-- todo: have problem in mobile device -->
                                                            <div class="btn-group">
                                                                <form  class="myAction" method="POST" action="{{route('TrainingInstitute.destroy',$uni_course->id)}}">
                                                                    @csrf
