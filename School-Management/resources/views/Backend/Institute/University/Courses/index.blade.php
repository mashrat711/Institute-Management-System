                                                ...
                                                @foreach($universities as $row)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{--</div>--}}
                                                            <div class="btn-group">
                                                                <a title="Edit" href="{{route('University.edit', $row->id)}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                                                </a>
                                                            </div>
                                                        {{--<div class="btn-group">--}}
                                                        ...
                                                        <!-- todo: have problem in mobile device -->
                                                            <div class="btn-group">
                                                                <form  class="myAction" method="POST" action="{{route('University.destroy',$row->id)}}">
                                                                    @csrf
