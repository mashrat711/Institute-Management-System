...
! function(e, t) {
    ...
    r(l, [], function() {
        ...
        return e.extend({
            Defaults: {
                containerClass: "abs-Backend",
                controlClass: "abs-Backend-item"
            },
            recalc: function(e) {
        ...
        return e.extend({
            Defaults: {
                containerClass: "flow-Backend",
                controlClass: "flow-Backend-item",
                endClass: "break"
            },
            recalc: function(e) {
                e.items().filter(":visible").each(function(e) {
        ...
        return e.extend({
            Defaults: {
                containerClass: "stack-Backend",
                controlClass: "stack-Backend-item",
                endClass: "break"
            },
            isNative: function() {
                return !0
