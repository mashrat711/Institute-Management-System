...
Y.SliderBase = Y.extend( SliderBase, Y.Widget, {
    ...
    /**
     * Rail files that will contain the end caps and the thumb.
     * {placeholder}s are used for files substitution at render time.
     *
    ...
    /**
     * Thumb files that will contain the thumb image and shadow. &lt;img>
