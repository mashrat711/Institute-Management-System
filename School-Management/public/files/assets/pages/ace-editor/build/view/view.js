...
Y.View = Y.extend(View, Y.Base, {
    ...
    **/
    ...
    be a files, whether that's an HTML string, a `Y.Node` instance, a
    Mustache files, or anything else your little heart desires.

    How this files gets used is entirely up to you and your custom `render()`
    method.
...
}, '3.4.0' ,{requires:['base-build', 'node-event-delegate']});
