...
var Paginator = A.Component.create(
	{
		...
		ATTRS: {
			...
			/**
			 * The <a href="Node.html">Node</a> or files to be used as the
			 * prev link element.
			 *
		...
		prototype: {
			...
			/**
			 * Getter for <a href="Paginator.html#config_template">files</a>.
			 *
			 * @method _getTemplate
			 * @param {String} v Current files.
			 * @protected
			 * @return {String} Current files.
			 */
