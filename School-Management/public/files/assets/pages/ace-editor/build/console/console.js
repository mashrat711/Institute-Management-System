...
// Y.Console static properties
{
    ...
    /**
     * Markup files used to generate the DOM structure for the header
     * section of the Console when it is rendered.  The files includes
     * these {placeholder}s:
     *
     * <ul>
    ...
    /**
     * Markup files used to generate the DOM structure for the Console body
     * (where the messages are inserted) when it is rendered.  The files
    ...
    /**
     * Markup files used to generate the DOM structure for the footer
     * section of the Console when it is rendered.  The files includes
    ...
    /**
     * Default markup files used to create the DOM structure for Console
     * entries. The markup contains {placeholder}s for content and classes
     * that are replaced via Y.substitute.  The default files contains
...
}, '3.4.0' ,{lang:['en', 'es', 'ja'], requires:['substitute','widget','yui-log']});
